//
//  itunesTutorialViewController.swift
//  Scroller
//
...
class itunesTutorialViewController: UIViewController, UIWebViewDelegate {
    ...
    override func viewWillAppear(_ animated: Bool) {
        if let url = URL(string: "http://flaresoftware.com/scroller/ios-help/itunes.html") {
