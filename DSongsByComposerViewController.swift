//
//  DSongsByComposerViewController.swift
//  Scroller
//
...
class DSongsByComposerViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, URLSessionDownloadDelegate  {
    ...
    var setlistName: String = "Scroller"
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.navigationItem.title = composerName
        
        let language = Locale.current.languageCode
        if language == "es" || language == "es-MX" { //ESPAÑOL
            setlistName = "Biblioteca de Scroller"
        } else {
            setlistName = "Scroller Library"
        }
    ...
    func configureMySession() {
        let config = URLSessionConfiguration.background(withIdentifier: "com.flaresoftware.scroller.\(composerName)Session")
