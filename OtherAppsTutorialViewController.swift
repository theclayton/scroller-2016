//
//  OtherAppsTutorialViewController.swift
//  Scroller
//
...
class OtherAppsTutorialViewController: UIViewController, UIWebViewDelegate {
    ...
    override func viewWillAppear(_ animated: Bool) {
        if let url = URL(string: "http://flaresoftware.com/scroller/ios-help/other-apps.html") {
