//
//  DownloadTutorialViewController.swift
//  Scroller
//
...
class DownloadTutorialViewController: UIViewController, UIWebViewDelegate {
    ...
    override func viewWillAppear(_ animated: Bool) {
        if let url = URL(string: "http://flaresoftware.com/scroller/ios-help/downloads.html") {
