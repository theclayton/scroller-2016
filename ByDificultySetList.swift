...
class ByDificultySetList: UIViewController, UITableViewDataSource, UITableViewDelegate, URLSessionDownloadDelegate  {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.titleLabel.text = ThisSetlistArray[indexPath.row].songName
        cell.composerLabel.text = ThisSetlistArray[indexPath.row].songComposer
